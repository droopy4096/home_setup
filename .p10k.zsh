# Generated by Powerlevel10k configuration wizard on 2021-05-03 at 11:00 MDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    local remote_sep='%f'     # default foreground
    ...
    if [[ -n $VCS_STATUS_REMOTE_NAME ]]; then
      res+="${remote_sep}:${remote}${(V)VCS_STATUS_REMOTE_NAME}/${(V)VCS_STATUS_REMOTE_BRANCH}"
    fi
  ...
  function prompt_glab() {
    if [[ -n "${GITLAB_TOKEN}" ]]; then
      p10k segment -b orange -f white -t 'GL'
    fi
  }
  typeset -g POWERLEVEL9K_GLAB_SHOW_ON_COMMAND='glab|my|my_*'
  typeset -g POWERLEVEL9K_GLAB_FOREGROUND=white
  typeset -g POWERLEVEL9K_GLAB_BACKGROUND=130
  function instant_prompt_glab() {
    prompt_glab
  }
  ...
  function p10k-on-pre-prompt() { 
    ...
    then
      p10k display '1'=hide '2'=show
    else
      p10k display '1|2/right'=show '2/left/vcs'=hide '2/left/dir'=hide '2/left/time'=hide '1/left/time'=show
    fi
    echo " - $(date)" >> ${LOG}
  }
  ...
  function p10k-on-post-prompt() { 
    LOG="${HOME}/tmp/p10k.log"
    echo -n "Post-prompt: $(date)" >> ${LOG}
    p10k display '1|2/right'=hide '2/left/glab'=hide '2/left/dir'=show '2/left/time'=show '1/left/time'=hide
    echo " - $(date)" >> ${LOG}
  }
